...
//        MaxActiveEnvironments = SQL_ACTIVE_ENVIRONMENTS,
//    
...
//        
//        // usmallint_t
//        MaxProcedureNameLength = 33, // SQL_MAX_PROCEDURE_NAME_LEN
//        
//        // uint_t
//        MaxRowSize = SQL_MAX_ROW_SIZE,
//        
//        // char_t to bool ('Y' == true)
//        MaxRowSizeIncludesLong = 103, // SQL_MAX_ROW_SIZE_INCLUDES_LONG
//        
//        // usmallint_t
...
//        
//        // char_t to bool ('Y' == true)
//        SupportsMultipleResultSets = 36, // SQL_MULT_RESULT_SETS
//        
//        // char_t to bool ('Y' == true)
//        SupportsMulitpleActiveTransactions = 37, // SQL_MULTIPLE_ACTIVE_TXN,
//        
//        // char_t to bool ('Y' == true)
...
//        
//        // indicates support for `SQLSetPos`
//        // int_t bitmask 
...
//        
//        // available transaction isolation options
//        // uint_t bitmask
...
{
    string_t name;
    smallint_t local_type;
}

class Connection : Handle
{
    package Environment _env;
    package bool autoCommit;
    package bool supports_describe_param;
    package int_t datetime_precision;
    package size_t timeout;
    package TextEncoding sqlchar_enc;
    package TextEncoding sqlwchar_enc;
    package TextEncoding unicode_enc;
    package size_t max_write;
    package size_t max_varchar_length;
    package size_t max_wvarchar_length;
    package size_t max_binary_length;
    ...
    {
        uint_t value;
        this.getAttribute(ConnectionAttributes.AccessMode, &value, SQL_IS_UINTEGER);
        return value.to!AccessMode;
    }

    public @property void accessMode(AccessMode input)
    {
        uint_t value = input.to!uint_t;
        this.setAttribute(ConnectionAttributes.AccessMode, cast(pointer_t) value, SQL_IS_UINTEGER);
    }

    public @property bool asyncEnabled()
    {
        ulen_t value;
        this.getAttribute(ConnectionAttributes.AsyncEnabled, &value, SQL_IS_UINTEGER);
    ...
    public @property void asyncEnabled(bool input)
    {
        ...
        this.setAttribute(ConnectionAttributes.AsyncEnabled, cast(pointer_t) value, SQL_IS_UINTEGER);
    }

    public @property bool autoImportParameterDescription()
    {
        uint_t value;
        this.getAttribute(ConnectionAttributes.AutoImportParameterDescription,
    ...
    public @property void autoImportParameterDescription(bool input)
    {
        ...
        this.setAttribute(ConnectionAttributes.AutoImportParameterDescription,
                cast(pointer_t) value, SQL_IS_UINTEGER);
    }

    public @property bool autocommit()
    {
        uint_t value;
        this.getAttribute(ConnectionAttributes.Autocommit, &value, SQL_IS_UINTEGER);
    ...
    public @property void autocommit(bool input)
    {
        ...
        this.setAttribute(ConnectionAttributes.Autocommit, cast(pointer_t) value, SQL_IS_UINTEGER);
    }

    public @property bool connectionDead()
    {
        uint_t value;
        this.getAttribute(ConnectionAttributes.ConnectionDead, &value, SQL_IS_UINTEGER);
    ...
    {
        uint_t value;
        this.getAttribute(ConnectionAttributes.ConnectionTimeout,
                cast(pointer_t) value, SQL_IS_UINTEGER);
        return value;
    }
    ...
    {
        this.setAttribute(ConnectionAttributes.ConnectionTimeout, &input, SQL_IS_UINTEGER);
    }
    ...
    {
        uint_t value;
        this.getAttribute(ConnectionAttributes.LoginTimeout, &value, SQL_IS_UINTEGER);
        return value;
    }

    private @property void loginTimeout(uint_t input)
    {
        this.setAttribute(ConnectionAttributes.LoginTimeout, cast(pointer_t) input, SQL_IS_UINTEGER);
    }

    public @property bool metadataID()
    {
        uint_t value;
        this.getAttribute(ConnectionAttributes.MetadataID, &value, SQL_IS_UINTEGER);
        return (value == SQL_TRUE);
    }
    ...
    {
        uint_t value = input ? SQL_TRUE : SQL_FALSE;
        this.setAttribute(ConnectionAttributes.MetadataID, cast(pointer_t) value, SQL_IS_UINTEGER);
    }

    public @property OdbcCursors odbcCursors()
    {
        ulen_t value;
        this.getAttribute(ConnectionAttributes.OdbcCursors, &value, SQL_IS_UINTEGER);
    ...
    private @property void odbcCursors(OdbcCursors input)
    {
        ...
        this.setAttribute(ConnectionAttributes.OdbcCursors, cast(pointer_t) input, SQL_IS_UINTEGER);
    }

    public @property uint_t packetSize()
    {
        uint_t value;
        this.getAttribute(ConnectionAttributes.PacketSize, &value, SQL_IS_UINTEGER);
        return value;
    }

    public @property void packetSize(uint_t input)
    {
        this.setAttribute(ConnectionAttributes.PacketSize, cast(pointer_t) input, SQL_IS_UINTEGER);
    }

    public @property window_t quietMode()
    {
        window_t value;
        this.getAttribute(ConnectionAttributes.QuietMode, &value, SQL_IS_POINTER);
        return value;
    }

    public @property void quietMode(window_t input)
    {
        this.setAttribute(ConnectionAttributes.QuietMode, input, SQL_IS_POINTER);
    }

    public @property bool trace()
    {
        uint_t value;
        this.getAttribute(ConnectionAttributes.Trace, &value, SQL_IS_UINTEGER);
    ...
    public @property void trace(bool input)
    {
        ...
        this.setAttribute(ConnectionAttributes.Trace, cast(pointer_t) value, SQL_IS_UINTEGER);
    }
    ...
    {
        int_t value;
        this.getAttribute(ConnectionAttributes.TransactionIsolation, &value, SQL_IS_UINTEGER);
        return value.to!TransactionIsolation;
    }

    public @property void transactionIsolation(TransactionIsolation input)
    {
        this.setAttribute(ConnectionAttributes.TransactionIsolation,
                cast(pointer_t) input, SQL_IS_UINTEGER);
    }
}
